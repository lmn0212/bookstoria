...
<div class="container main">
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-9 content">
            ...
            <div class="row justify-content-center novisiblemobile">
                <div class="col-12">
                ...
                <div class="regulartrailer slick-slider row">
                    ...
                    <div>
                        <div class="catalog-book-item">
                            <iframe width="100%" height="auto" src="https://www.youtube.com/embed/{{$t->booktailer}}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            ...
            <div class="row justify-content-center wow fadeInUp">
                ...
                <div class="regular slick-slider row">
                    ...
                    <div>
                        <div class="catalog-book-item">
                            <a href="{{route('getbook', ['id' => $book->id])}}">
