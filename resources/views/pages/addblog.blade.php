            ...
            <div class="col-12 col-md-8 col-lg-9 content" style="margin-top: 60px;">
                <div class="row justify-content-center">
                    <div class="col-10">
                        ...
                        <form class="wow fadeInUp" method="POST" action="/blog/addblog" enctype="multipart/form-data">
                            <div class="form-row justify-content-center">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="tags" class="form-control" placeholder="Ключевые слова" required>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <textarea class="form-control" name="text" rows="12" placeholder="Содержимое записи"  required></textarea>
                                </div>
